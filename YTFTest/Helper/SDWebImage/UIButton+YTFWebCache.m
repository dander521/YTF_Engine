...
#import "UIButton+YTFWebCache.h"
#import "objc/runtime.h"
#import "UIView+YTFWebCacheOperation.h"

static char imageURLStorageKey;

@implementation UIButton (YTFWebCache)
...
- (void)sd_setImageWithURL:(NSURL *)url forState:(UIControlState)state placeholderImage:(UIImage *)placeholder options:(SDWebImageOptions)options completed:(SDWebImageCompletionBlock)completedBlock {
    ...
    id <YTFSDWebImageOperation> operation = [YTFSDWebImageManager.sharedManager downloadImageWithURL:url options:options progress:nil completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, BOOL finished, NSURL *imageURL) {
        if (!wself) return;
...
- (void)sd_setImageLoadOperation:(id<YTFSDWebImageOperation>)operation forState:(UIControlState)state {
...
- (void)sd_setBackgroundImageLoadOperation:(id<YTFSDWebImageOperation>)operation forState:(UIControlState)state {
...
@implementation UIButton (YTFWebCacheDeprecated)
