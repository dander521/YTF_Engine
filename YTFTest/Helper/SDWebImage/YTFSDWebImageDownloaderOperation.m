...
@interface YTFSDWebImageDownloaderOperation ()
...
@implementation YTFSDWebImageDownloaderOperation {
    size_t width, height;
    ...
    if ((self.options & SDWebImageDownloaderProgressiveDownload) && self.expectedSize > 0 && self.completedBlock) {
        ...
        if (width + height > 0 && totalSize < self.expectedSize) {
            ...
            if (partialImageRef) {
                ...
                NSString *key = [[YTFSDWebImageManager sharedManager] cacheKeyForURL:self.request.URL];
