...
#import "YTFSDWebImagePrefetcher.h"

@interface YTFSDWebImagePrefetcher ()

@property (strong, nonatomic) YTFSDWebImageManager *manager;
...
@implementation YTFSDWebImagePrefetcher
...
- (id)init {
    return [self initWithImageManager:[YTFSDWebImageManager new]];
}
