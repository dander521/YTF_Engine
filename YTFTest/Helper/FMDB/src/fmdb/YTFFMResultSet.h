...
@interface YTFFMResultSet : NSObject {
    YTFFMDatabase          *_parentDB;
    YTFFMStatement         *_statement;
...
@property (atomic, retain) YTFFMStatement *statement;
...
+ (instancetype)resultSetWithStatement:(YTFFMStatement *)statement usingParentDatabase:(YTFFMDatabase*)aDB;

/** Close result set */

- (void)close;

- (void)setParentDB:(YTFFMDatabase *)newDb;
