...
@interface YTFFMDatabasePool()

- (void)pushDatabaseBackInPool:(YTFFMDatabase*)db;
- (YTFFMDatabase*)db;

@end


@implementation YTFFMDatabasePool
...
- (YTFFMDatabase*)db {
    ...
    [self executeLocked:^() {
        ...
        if (db) {
            ...
            db = [YTFFMDatabase databaseWithPath:self->_path];
