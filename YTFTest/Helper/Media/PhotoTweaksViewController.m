...
- (void)saveBtnTapped
{
    ...
    NSString *filePath = [[paths objectAtIndex:0] stringByAppendingPathComponent:[NSString stringWithFormat:@"savePhotoSigal%@.png",randName]];   //通过取名字不同 从而 保存文件的
...
//通知回调image信息
    [[NSNotificationCenter defaultCenter]postNotificationName:@"namephotoCropNotific"  object:nil userInfo:@{@"imagePath":filePath,@"imageUrl":@"nil"}];
