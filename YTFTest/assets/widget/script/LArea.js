	...
	MobileArea.prototype = {
		...
		bindEvent : function() {
			...
			function gearTouchMove(e) {
				...
				if (target.classList.contains("area_province")) {
					isProMove = true;
					isCityMove = true;
				}
				if (target.classList.contains("area_city")) {
					isCityMove = true;
				}
			...
			function gearTouchEnd(e) {
				...
				if ((target.classList.contains("area_province") && isProMove) || (target.classList.contains("area_city") && isCityMove)) {
