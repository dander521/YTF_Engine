...
//        id  dscsd = [dict objectForKey:categoryId];
//        NSLog(@"[dict objectForKey:categoryId]==========%@",dscsd);
                       ...
                       timestamp:(UInt32)timestamp_key
{
    ...
    //添加商户密钥key字段
    // 注意此处一定要添加上商户密钥
    [contentString appendFormat:@"key=%@", [AppDelegate getExtendWithPluginName:@"weixin"][@"partner_key"]];
